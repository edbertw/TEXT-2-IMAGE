...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}>
      ...
      >
        <p>Your trusted text to image generator</p>
        <img src={assets.star_icon} alt=""/>
      </motion.div>
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7x1 sm:max-w-[590px] mx-auto mt-10 text-center'
      >Turn text to  
      ...
      > Unleash your creativity with AI. Turn your words into art in mere seconds - type, and watch the magic happen</motion.p>
