...
const Login = () => {
  ...
  return (
    ...
    className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        mt-5'>
            <img src={assets} alt=""/>
            <input onChange={e => setName(e.target.value)} value = {name} type="text" //get the value from the fields
            className='outline-none text-sm' placeholder='Enter Full Name' required />
        </div>}
        ...
        mt-4'>
            ...
            className='outline-none text-sm' placeholder='Enter Email' required />
        </div>

        <div className='border px-6 py-2 flex items-center gap-2 rounded-full
        mt-4'>
            <img src={assets.lock_icon} alt=""/>
            <input onChange={e => setPassword(e.target.value)} value = {password} type="password" //data stored in state variables
